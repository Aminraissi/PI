export default class Autopilot
{
    constructor(_options)
    {
        ...
        this.waypoints = [
            ...
            { x:  30,   y: -30,   pause: 3.5, label: 'Scene 1 \u00b7 Origines de l\'agriculture' },
            { x:  54,   y: -30,   pause: 3.5, label: 'Scene 2 \u00b7 Irrigation et premieres cites' },
            { x:  78,   y: -30,   pause: 3.5, label: 'Scene 3 \u00b7 Outils et terrasses' },
            { x: 102,   y: -30,   pause: 3.5, label: 'Scene 4 \u00b7 Agriculture medievale' },
            { x: 126,   y: -30,   pause: 3.5, label: 'Scene 5 \u00b7 Revolution scientifique' },
            { x: 150,   y: -30,   pause: 3.5, label: 'Scene 6 \u00b7 Revolution industrielle' },
            { x: 174,   y: -30,   pause: 3.5, label: 'Scene 7 \u00b7 Chimie et conservation' },
            { x: 198,   y: -30,   pause: 3.5, label: 'Scene 8 \u00b7 Mecanisation moderne' },
            { x: 222,   y: -30,   pause: 3.5, label: 'Scene 9 \u00b7 Agriculture numerique' },
            { x: 246,   y: -30,   pause: 3.5, label: 'Scene 10 \u00b7 L\'avenir' },
            { x: 270,   y: -30,   pause: 3.5, label: 'Scene finale \u00b7 Agri Film' },
            { x: 284,   y: -30,   pause: 0,   label: '' },

            // ── Explorer management panels ───────────────────────────
            { x: 304,   y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Delivery' },
            { x: 314.5, y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Inventory' },
            { x: 325,   y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Appointments' },
            { x: 335.5, y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Animals' },
            { x: 346,   y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Marketplace' },
            { x: 356.5, y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Forum' },
            { x: 367,   y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Loans' },
            { x: 377.5, y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Events' },
            { x: 388,   y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Trainings' },
            { x: 398.5, y: -30,   pause: 3.5, threshold: 2.5, preciseStop: true, label: 'Explorer \u00b7 Help Request' },
